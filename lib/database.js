...
module.exports = {
  ...
  get_stats: function(coin, cb) {
    Stats.findOne({coin: coin}, function(err, stats) {
      if(stats) {
	stats.supply = stats.supply-1000000000;
        return cb(stats);
      } else {
        return cb(null);
      }
  ...
  update_richlist: function(list, cb){
    if(list == 'received') {
      Address.find({a_id:{$nin:["TcCajdGoxgaRhz7drdYSWuDQ1k8c9i6szX","ThzuuY3PdnPsmsJs7bYDzwWQj42pWdHvsS","TkzhqmKGYVLF4h8GWpiB7aP1qyqBfBG7kU","TxVEaALFpjiaGGmtXKDVgesWLP48FpCkVc","TgZyQFC2nMWdRQJZBfJt39kVdZDK96xfFZ","TkHojsDdj1TVFxVWxQg5MYa7mEAtD5Sh6w","TmzqBaitXSg4CvSBqRcrEtb4t87j5AT34d","Tr5r4KN2oBkZdzAezuX8Z8kz3YjGEcdnna","TqnBcaWeZdf6Woc2Upij9w6bXAALFV9Lqb","TdWHKTc3HfML8EQsH6NfNkVokRiyeZZEP1","TqMtdPA4KwQAaWwCpgkEcwbLsH7u75hubb","TxGeA1BovJwxgUeUZH1LDg22NL5pAkpf9Z","TvM7vUZDGaKa65qUDjh5ARyXkR3K384Rxf","Tc3uaF3daM6Qqav4sq9VtnfmYGntFxiLw7","TfBi3hdYwNo9PCEswNriU5kuC1KyYoAoFj","TeKhqHbmeMujNTuSFv8BqhRPAH5sGqBG5S","TdJ2x2oo3zuDLdeQ5sdbtenyYupDeA4BDv","Tg2dU9HHXVkz2EJgGwxWPuJx5G51cbdgKY","TcS8UWcUEsiwgkZFyDQG37mpEJg8CsYZtt","Tw2w9YeCPCLLYvHBWiKaWomLZ2tDXwwtp2"]}}).sort({received: 'desc'}).limit(100).exec(function(err, addresses){
      ...
      Address.find({a_id:{$nin:["TcCajdGoxgaRhz7drdYSWuDQ1k8c9i6szX","ThzuuY3PdnPsmsJs7bYDzwWQj42pWdHvsS","TkzhqmKGYVLF4h8GWpiB7aP1qyqBfBG7kU","TxVEaALFpjiaGGmtXKDVgesWLP48FpCkVc","TgZyQFC2nMWdRQJZBfJt39kVdZDK96xfFZ","TkHojsDdj1TVFxVWxQg5MYa7mEAtD5Sh6w","TmzqBaitXSg4CvSBqRcrEtb4t87j5AT34d","Tr5r4KN2oBkZdzAezuX8Z8kz3YjGEcdnna","TqnBcaWeZdf6Woc2Upij9w6bXAALFV9Lqb","TdWHKTc3HfML8EQsH6NfNkVokRiyeZZEP1","TqMtdPA4KwQAaWwCpgkEcwbLsH7u75hubb","TxGeA1BovJwxgUeUZH1LDg22NL5pAkpf9Z","TvM7vUZDGaKa65qUDjh5ARyXkR3K384Rxf","Tc3uaF3daM6Qqav4sq9VtnfmYGntFxiLw7","TfBi3hdYwNo9PCEswNriU5kuC1KyYoAoFj","TeKhqHbmeMujNTuSFv8BqhRPAH5sGqBG5S","TdJ2x2oo3zuDLdeQ5sdbtenyYupDeA4BDv","Tg2dU9HHXVkz2EJgGwxWPuJx5G51cbdgKY","TcS8UWcUEsiwgkZFyDQG37mpEJg8CsYZtt","Tw2w9YeCPCLLYvHBWiKaWomLZ2tDXwwtp2"]}}).sort({balance: 'desc'}).limit(100).exec(function(err, addresses){
        Richlist.update({coin: settings.coin}, {
          balance: addresses,
        }, function() {
          return cb();
